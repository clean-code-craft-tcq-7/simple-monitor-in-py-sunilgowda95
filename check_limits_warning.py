...
def test_cases_warning_temperature():
...
def test_cases_warning_charge_rate():
...
def test_cases_warning():
  test_cases_warning_temperature() 
  test_cases_warning_soc()
  test_cases_warning_charge_rate()
  test_cases_warning_all()